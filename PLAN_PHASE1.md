...
> **Status: complete (v0.1.0, 2026-04-28).** Original landing of the
> framework. See [`CHANGELOG.md`](CHANGELOG.md) `## [0.1.0]` for the full
> diff.
>
> This file extracts the original Phase 1 plan body that lived inline in
> [PLAN.md](PLAN.md) so PLAN.md can be a high-level index. Successor:
